...
public class EmployeeControl {
    ...
    public Employee newEmployee(int id) {
        ...
        Syndicate syndicate = getinfo.syndicate();
        ...
        switch (type){
            ...
            case 1: return new Hourly(id, name, address, syndicate);
            case 2: return new Salaried(id, name, address, syndicate, salary);
            case 3: return new Commissioned(id, name, address, syndicate, salary, commission);
        }
        return null;
    }
    ...
    public Employee editEmployee(Employee employee) {
        if(employee != null) {
            ...
            Payment payment_schedule = new Payment(new Payday(), 0);
            ...
            while (true) {
                try {
                    ...
                    switch (option) {
                        ...
                        case 4: syndicate = getinfo.syndicate(); break;
                        case 5: commission_percent = getinfo.commission(); break;
                    }
                    break;
                } catch (InputMismatchException e) {
                    format.invalidInput();
            ...
            if(new_type == type) {
                if (type == 1) return new Hourly(id, name, address, syndicate, payment_schedule);
                else if (type == 2) return new Salaried(id, name, address, syndicate, payment_schedule);
                else if (type == 3) return new Commissioned(id, name, address, syndicate, commission_percent, payment_schedule, sales);
            } else if (new_type == 0){
                ...
                if(type == 1){
                    ...
                    if(new_type == 2){
                        return new Salaried(id, name, address, syndicate, salary);
                    }
                    else if(new_type == 3) {
                        int commission = getinfo.commission();
                        return new Commissioned(id,name, address, syndicate, salary, commission);
                    }
                } else if(type == 2){
                    if(new_type == 1) {
                        return new Hourly(id, name, address, syndicate);
                    }
                    else if(new_type == 3) {
                        double salary = getinfo.salary();
                        int commission = getinfo.commission();
